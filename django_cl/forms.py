...
from cl_reg_prov_com import (REGION_CHOICES, PROVINCIA_CHOICES,
                             COMUNA_CHOICES, REGION_PROVINCIA_CHOICES,
...
class CLProvinciaSelect(Select):
    """
    A Select widget that uses a list of Chilean Provinces (Provincias)
    as its choices."""

    def __init__(self, attrs=None):
        super(CLProvinciaSelect, self).__init__(attrs, choices=PROVINCIA_CHOICES)


class CLComunaSelect(Select):
    """
    A Select widget that uses a list of Chilean Communes (Comunas)
    as its choices."""

    def __init__(self, attrs=None):
        super(CLComunaSelect, self).__init__(attrs, choices=COMUNA_CHOICES)
